...
- [ ] 1.1 Escribir las pruebas del contrato de un contexto: enunciado no vacío, respuesta dentro del temario (no negativa, hasta tres decimales), y **ningún enunciado nombra la técnica**.
- [ ] 1.2 Escribir la prueba de rangos: generando cada contexto muchas veces, todas las cantidades caen dentro de lo que declara.
- [ ] 1.3 Definir el tipo `Contexto` con sus rangos, su técnica y sus formas de equivocarse.
- [ ] 1.4 Escribir los contextos de **decimales**: masas, dinero, medidas, agua caída, tiempos de carrera. Al menos diez.
- [ ] 1.5 Escribir los de **fracciones**: repartos, recetas, partes de un total. Al menos diez.
- [ ] 1.6 Escribir los de **ecuaciones**: cuánto falta, cuánto había antes, edades. Al menos diez.
- [ ] 1.7 Escribir los de **inecuaciones**: cupos, pesos máximos, presupuestos, «como máximo» y «al menos». Al menos diez.
- [ ] 1.8 Prueba de cobertura: las cuatro técnicas presentes y ninguna con más de la mitad del catálogo.
